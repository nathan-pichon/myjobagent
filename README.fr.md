...
au réseau) : le Kanban (drag & drop) et ton feedback s'enregistrent directement dans
...
**Feedback sur une offre** — dans le détail d'une offre, deux boutons alimentent la stratégie
de l'agent (`mja tune`) : **« Pas pertinent »** (l'offre a été sur-notée) et **« Périmée »**
(offre expirée/obsolète). En CLI : `mja flag <url> irrelevant|outdated [--undo]`.
